...
REM
REM $Header: 1366133.1 sqlhcxec.sql 11.4.5.3 2012/12/31 carlos.sierra $
REM
...
HOS tkprof ^^udump_path.*^^script._^^unique_id.*.trc ^^files_prefix._tkprof_from_tool_exec.txt
...
HOS zip -m ^^files_prefix._9_log.zip ^^files_prefix._tkprof_from_tool_exec.txt
