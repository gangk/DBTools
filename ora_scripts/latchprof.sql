...
COL latchprof_total_ms HEAD "Held ms" FOR 99999999.999
COL latchprof_pct_total_samples head "Held %" format 99999.99
COL latchprof_avg_ms HEAD "Avg hold ms" FOR 99999.999
...
PROMPT
PROMPT -- LatchProf 1.21 by Tanel Poder ( http://www.tanelpoder.com )
...
WITH 
    ...
    samples AS (
        SELECT /*+ ORDERED USE_NL(l) USE_NL(s) NO_TRANSFORM_DISTINCT_AGG commented out:USE_NL(l.gv$latchholder.x$ksuprlat) */
            &_lhp_what
