...
--------------------------------------------------------------------------------
--
PROMPT   The Session Snapper v3.14
--   (c) Tanel Poder ( http://tech.e2sn.com )set termout off tab off verify off linesize 299
---------------------------------------------------------------------------------
...
begin
    ...
    if pagesize > 0 then
        output(' ');
        output('-- Session Snapper v3.14 by Tanel Poder @ E2SN ( http://tech.e2sn.com )');
        output(' ');
    end if;
