...
select snap_id, TO_CHAR(tm,'YY/MM/DD HH24:MI') tm, inst, dur, tsname, file#, filename, io_rank, readtim, reads, atpr, rps, bpr, writetim, writes, atpw, wps, bpw, waits, atpwt, ios, iops
from
