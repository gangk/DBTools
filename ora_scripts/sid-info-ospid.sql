REM ------------------------------------------------------------------------------------------------
REM $Id: sid-info-ospid.sql,v 1.1 2002/03/14 00:27:55 hien Exp $
REM Author     : hien
REM #DESC      : Show all session related information for a single session given an OS PID
REM Usage      : Input parameter: os_pid
REM Description: 
REM ------------------------------------------------------------------------------------------------
