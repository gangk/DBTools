...
REM
REM $Header: 1366133.1 sqldx.sql 11.4.5.3 2012/12/31 carlos.sierra $
REM
...
DEF doc_ver = '11.4.5.3';
DEF doc_date = '2012/12/31';
...
SELECT 'license: ' x, UPPER(SUBSTR(TRIM('^^input_license.'), 1, 1)) olicense FROM DUAL;
VAR olicense CHAR(1);
...
SELECT 'output_type: ' x, UPPER(SUBSTR(TRIM('^^input_output_type.'), 1, 1)) output_type FROM DUAL;
      ...
      LOOP
        ...
        IF l_cnt > 0 THEN
          ...
          IF :output_type IN ('H', 'B') THEN
            ...
            put_line('SET LIN 80;');
            put_line('PRO <pre>');
            put_line('DESC '||l_table_name);
            put_line('PRO </pre>');
            put_line('SET LIN 2000;');
            put_line('SET HEA ON PAGES 25 MARK HTML ON TABLE "" SPOOL OFF;');
            put_line('SELECT ROWNUM "#", v.* FROM (SELECT /*+ NO_MERGE */ '||l_columns_list||' FROM '||l_table_name||'^^my_dblink. WHERE '||i.column_name||' = ''^^sql_id.'') v;');
          ...
          IF :output_type IN ('C', 'B') THEN
            ...
            put_line('SELECT '||l_columns_list||' FROM '||l_table_name||'^^my_dblink. WHERE '||i.column_name||' = ''^^sql_id.'';');
      ...
      LOOP
        ...
        IF l_cnt > 0 THEN
          ...
          IF :output_type IN ('H', 'B') THEN
            ...
            put_line('SET LIN 2000;');
            put_line('SET HEA ON PAGES 25 MARK HTML ON TABLE "" SPOOL OFF;');
            put_line('SELECT ROWNUM "#", v.* FROM (SELECT /*+ NO_MERGE */ '||l_columns_list||' FROM '||l_table_name||'^^my_dblink. WHERE '||i.column_name||' = ^^signature.) v;');
            put_line('SET HEA OFF PAGES 0 MARK HTML OFF;');
            put_footer;
            put_line('SPO OFF;');
          ELSE
          ...
          IF :output_type IN ('C', 'B') THEN
            ...
            put_line('SET HEA ON PAGES 50000 LIN 32767 LONGC 4000 COLSEP '','';');
            put_line('SELECT '||l_columns_list||' FROM '||l_table_name||'^^my_dblink. WHERE '||i.column_name||' = ^^signature.;');
            put_line('SET HEA OFF PAGES 0 LIN 2000 LONGC 2000 COLSEP '' '';');
            put_line('SPO OFF;');
          ELSE
            put_line('-- output_type: '||:output_type);
      ...
      LOOP
        ...
        IF l_cnt > 0 THEN
          ...
          IF :output_type IN ('H', 'B') THEN
            ...
            put_line('SET LIN 2000;');
            put_line('SET HEA ON PAGES 25 MARK HTML ON TABLE "" SPOOL OFF;');
            put_line('SELECT ROWNUM "#", v.* FROM (SELECT /*+ NO_MERGE */ '||l_columns_list||' FROM '||l_table_name||'^^my_dblink. WHERE '||i.column_name||' = ^^signaturef.) v;');
            put_line('SET HEA OFF PAGES 0 MARK HTML OFF;');
            put_footer;
            put_line('SPO OFF;');
          ELSE
          ...
          IF :output_type IN ('C', 'B') THEN
            ...
            put_line('SET HEA ON PAGES 50000 LIN 32767 LONGC 4000 COLSEP '','';');
            put_line('SELECT '||l_columns_list||' FROM '||l_table_name||'^^my_dblink. WHERE '||i.column_name||' = ^^signaturef.;');
            put_line('SET HEA OFF PAGES 0 LIN 2000 LONGC 2000 COLSEP '' '';');
            put_line('SPO OFF;');
          ELSE
            put_line('-- output_type: '||:output_type);
      ...
      LOOP
        ...
        IF l_cnt > 0 THEN
          ...
          IF :output_type IN ('H', 'B') THEN
            ...
            put_line('SET LIN 2000;');
            put_line('SET HEA ON PAGES 25 MARK HTML ON TABLE "" SPOOL OFF;');
            put_line('SELECT ROWNUM "#", v.* FROM (SELECT /*+ NO_MERGE */ '||l_columns_list||' FROM '||l_table_name||'^^my_dblink.) v;');
            put_line('SET HEA OFF PAGES 0 MARK HTML OFF;');
            put_footer;
            put_line('SPO OFF;');
          ELSE
          ...
          IF :output_type IN ('C', 'B') THEN
            ...
            put_line('SET HEA ON PAGES 50000 LIN 32767 LONGC 4000 COLSEP '','';');
            put_line('SELECT '||l_columns_list||' FROM '||l_table_name||'^^my_dblink.;');
            put_line('SET HEA OFF PAGES 0 LIN 2000 LONGC 2000 COLSEP '' '';');
            put_line('SPO OFF;');
          ELSE
            put_line('-- output_type: '||:output_type);
