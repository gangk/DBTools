...
--
--
-- Version :  Coskan Gundogar:  Changed to put varchar2(32) instead of date datatypes 
-------------------------------------------------------------------------------------------------------
--
...
-- Generate statement
--
select regexp_replace(sql_fulltext,'(select |SELECT )','select /* test_&&sql_id */ /*+ gather_plan_statistics */ ',1,1) sql_fulltext from (
