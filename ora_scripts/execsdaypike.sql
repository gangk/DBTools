...
from 
	dba_hist_sqlstat sql, dba_hist_snapshot snap where snap.snap_id=sql.snap_id and  trunc(begin_interval_time) between trunc(sysdate-2) and trunc(sysdate)
