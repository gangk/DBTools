...
column CWait_per_exec format 99,999.999  heading 'Concur|Wait|per|Exec'
column CLWait_per_exec format 99,999.999 heading 'Clust|Wait|per|Exec'
column Rows_per_exec format 99,999.999
column Gets_per_exec format 9,999,999.999 heading 'Gets|Per|Exec'
...
--        ,s.snap_id
        ,to_char(s.begin_interval_time,'YY-MM-DD:HH24') as BEGIN_TIME
